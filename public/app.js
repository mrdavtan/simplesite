...
document.getElementById('postForm').addEventListener('submit', async function(e) {
    ...
    const publishedDate = document.getElementById('publishedDate').value; // Ensure this line is correctly capturing the date
    ...
    const post = {
        title,
        content,
        publishedDate, // Make sure this is included
        seoTitle,
        seoDescription,
        seoKeywords
    };
